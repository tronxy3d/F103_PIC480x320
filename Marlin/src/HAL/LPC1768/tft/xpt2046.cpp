...
#define TOUCH_CHECK_TIME    3000
static uint16_t z1_value = 0;
uint16_t z1_touch_threshold = XPT2046_Z1_THRESHOLD;
bool XPT2046::isTouched() {
    if(isBusy())return false;
    z1_value = getRawData(XPT2046_Z1);
    if(millis() > TOUCH_CHECK_TIME)return z1_value >= z1_touch_threshold;
    if(z1_value > z1_touch_threshold)z1_touch_threshold = z1_value + 5;
    return z1_value >= XPT2046_Z1_THRESHOLD;
}
