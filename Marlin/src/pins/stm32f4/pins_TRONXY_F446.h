...
//PF11-Z_MAX_PIN
  ...
  #if Z_HOME_DIR > 0 //由于换大端后,固件用Z_MAX作Z1限位,但实际上,我们依然用Z_MIN作Z1的限位
...
#endif
#if TRONXY_PROJ == PROJ_XY2_PRO_3E || TRONXY_PROJ == PROJ_X5SA_PRO_3E
  #ifndef FIL_RUNOUT3_PIN
  #define FIL_RUNOUT3_PIN                   PC0 //主板上没有接口,使用T1温度传感器摸拟
  #endif
#endif
